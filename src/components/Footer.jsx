    ...
    return  <footer  className='footer bg-[#4c637c]/70 p-10 '   >
      <div className="lg:w-10/12 space-y-5  mx-auto footer text-base-content *:text-white sm:footer-horizontal  ">
        ...
        <nav>
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14598.796932347963!2d90.44081905902821!3d23.829291952152886!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1749998277275!5m2!1sen!2sbd" width="350" className='mt-2 rounded-xl' height="200" style={{border:0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </nav>
      </div>
    </footer>
};
