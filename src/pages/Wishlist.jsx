...
const Wishlist = () => {
  ...
  return (
    <div className="pt-28">
      {wishlist?.length < 1 ? (
        <div className="bg-gray-100  p-6 w-11/12 md:w-10/12 lg:w-8/12 mx-auto rounded-xl my-8 min-h-[470px]">
          <div className="lg:w-96 md:w-72 w-64 mx-auto">
            <Lottie animationData={wishJson} />
          </div>
          <div className=" flex bg-gray-300 border-gray-500 border rounded-xl items-center justify-center">
            <div className="lg:w-40 w-32 md:w-36 ">
              {" "}
              <img
                className=" w-fit  mx-auto"
                src={wishPic}
                alt="wishlist demo img"
              />
            </div>
            <h2 className="font-bold text-2xl md:text-4xl text-[#4c637c] lg:text-6xl   text-center">
              {" "}
        ...
        <>
          ...
          <p className="text-center w-11/12 mx-auto  text-gray-400">
            Here are the blogs you've marked to read later or found interesting.
            Easily revisit your favorite posts anytime from your personalized
            wishlist.
          </p>
